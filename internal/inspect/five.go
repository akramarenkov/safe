...
// Performs inspection.
func (opts Opts5[Type]) Do() (Result[Type, Type, int64], error) {
...
func (opts *Opts5[Type]) main() Result[Type, Type, int64] {
...
func (opts *Opts5[Type]) loop(firsts chan int64) Result[Type, Type, int64] {
	result := Result[Type, Type, int64]{}
